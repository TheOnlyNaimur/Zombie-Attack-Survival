...
def drawTrees():
    # Draw trees at fixed random positions
    tree_positions = [
        (-300, -300), (-200, -400), (-100, -500), (200, -200), (100, -300),
        (200, -300), (300, -400), (400, -500), (300, -100), (200, -550),
        (-500, -200), (300, -200), (-600, -400), (500, -500), (-450, -100)
    ]
    ...
    for x, z in tree_positions:
        ...
        glColor3f(0.55, 0.27, 0.07)  # Darkish brown
        glPushMatrix()
        glRotatef(-90, 1, 0, 0)  # Rotate to make cylinder vertical
        gluCylinder(gluNewQuadric(), 10, 10, 50, 10, 10)  # Increased radius from 5 to 8
        glPopMatrix()

        # Draw tree top (sphere)
        glColor3f(0.0, 0.5, 0.0)  # Green
        glPushMatrix()
        glTranslatef(0, 50, 0)  # Position the sphere on top of the trunk
        glutSolidSphere(40, 10, 10)  # Increased radius from 20 to 30
        glPopMatrix()
